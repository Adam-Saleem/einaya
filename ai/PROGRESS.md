...
**Active phase:** Visual refresh — palette, landing, and auth pages rebuilt against the "Accessible & Ethical" design system generated by the ui-ux-pro-max skill (cyan-teal primary + emerald CTA). Authenticated app surfaces still use the prior layout — they pick up the new palette automatically through the token swap.
